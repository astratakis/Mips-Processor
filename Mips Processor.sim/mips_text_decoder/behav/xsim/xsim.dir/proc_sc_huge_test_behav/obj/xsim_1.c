...
{
	iki_relocate(dp, "xsim.dir/proc_sc_huge_test_behav/xsim.reloc",  (void **)funcTab, 44);
	iki_vhdl_file_variable_register(dp + 156304);
	iki_vhdl_file_variable_register(dp + 156360);
